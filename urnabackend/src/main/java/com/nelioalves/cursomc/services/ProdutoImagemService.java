...
public class ProdutoImagemService {
    ...
    public ProdutoImagemService(@Value("${file.upload-dir}") String uploadDir) throws IOException {
    ...
    private void saveImageToFile(MultipartFile file, Path filePath) throws IOException {
    ...
    public File getImageFileByProdutoIdAndImageName(Integer produtoId, String imageName) {
        Path filePath = uploadPath.resolve(produtoId.toString()).resolve(imageName);
